...
function initAnalytics() {
    ...
    // Redundant logoutBtn listener removed to use the more advanced one below
...
function startLiveUpdates() {
    ...
    // Every 30 seconds, sync with backend if online, otherwise simulate local
    setInterval(() => {
        fetchHistoryFromBackend();
        fetchWeather();
        fetchSmsLogs();
    ...
    // Every 30 seconds, simulate a new sensor reading & classification locally for visual dynamism
    setInterval(simulateSensorEvent, 30000);
